...
<svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M21.375 18V24.75" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M6.75 23.625V21.375C6.75 20.1815 7.22411 19.0369 8.06802 18.193C8.91193 17.3491 10.0565 16.875 11.25 16.875H15.75" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </g>
    <defs>
